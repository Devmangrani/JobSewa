    ...
    return(
        ...
        <section>
            ...
            {/* <h1 className="text-6xl font-bold text-white text-center underline">Multirotors</h1> */}
                ...
                <div>
                    <h1 className="text-4xl font-bold text-white text-center">{product.title}</h1>
                    ...
                    <div className="mt-5">
                        <img src={product.url} className="object-cover h-180 w-full rounded-xl"></img>
                    </div>
                    ...
                    <div className="flex flex-row pr-15 pl-15 pb-15 pt-10">
                        ...
                        <img src={product.url} className="h-120 w-170 rounded-2xl"></img>
                    </div>
