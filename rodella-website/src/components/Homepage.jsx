  ...
  return (
    <div>
      <section className="h-screen relative">
        <img
          className="absolute top-0 left-0 w-full h-full object-cover brightness-60 -z-50"
          src={BackgroundImage}
        ></img>
          ...
          <div className="flex flex-row items-center ml-30 h-full">
            <div className="flex flex-col w-fit lg:mb-30">
              ...
              <div className="flex my-10 flex-row">
                <a
                  href="#"
                  className="text-black bg-white px-4 py-4 rounded-md mr-4"
                >
                  Get in touch
                </a>
                <a
                  href="#"
                  className="text-white bg-black px-4 py-4 rounded-md"
                >
      ...
      <section className="bg-neutral-300 pt-10 pb-10">
        <div className="flex flex-col mt-30">
          <div className="flex flex-row justify-between lg:ml-30 lg:mr-30">
            <div className="flex flex-col">
              <h1 className="text-4xl font-bold">Why choose us?</h1>
              <p className="text-sm mt-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
              <img src={ChooseUsImage} className="w-150 h-100 mt-10 rounded-2xl"></img>
            </div>
              ...
              <div className="flex flex-row justify-between">
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-row justify-between mt-12">
                    ...
                    <p className="bg-gradient-to-r from-orange-300 to-orange-500 bg-clip-text text-xl">25k+</p>
                  </div>
                  <div className="flex flex-row justify-between mt-12">
                    <h1 className="text-xl">Quality Control</h1>
                    <p className="bg-gradient-to-r from-orange-300 to-orange-500 bg-clip-text text-xl">200+</p>
                  </div>
                  <div className="flex flex-row justify-between mt-12">
                    <h1 className="text-xl">Long term support</h1>
                    <p className="bg-gradient-to-r from-orange-300 to-orange-500 bg-clip-text text-xl">150+</p>
                  </div>
                </div>
                <div className="flex flex-col">
      ...
      <section className="bg-neutral-300 pt-10 pb-10">
        ...
        <div className="mt-20 mr-30 ml-30 mb-30">
          <Slider {...settings}>
            {cards.map((card) => (
              <div key={card.id} className="bg-white h-[300px] text-black rounded-xl">
                <div className="h-full w-full flex justify-center items-center">
                  <img src={card.url} alt={card.title} className="h-full object-cover" />
                </div>
