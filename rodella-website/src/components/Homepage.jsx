    ...
    <div className="flex flex-col h-[95vh] justify-between items-center">
        ...
        <div className="flex flex-col items-center mt-25 lg:mt-35">
            ...
            <p className="mt-6 text-lg text-center text-neutral-500 max-w-4xl">
                ...
                Eius atque beatae quaerat nobis commodi illum autem corrupti nisi iure animi.
                Id voluptas ipsam non sint beatae impedit quas vel deleniti nihil quidem.
            </p>
            <div className="flex justify-center my-10">
                <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 px-4 py-4 rounded-md">
